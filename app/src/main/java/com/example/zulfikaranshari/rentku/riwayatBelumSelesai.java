...
public class riwayatBelumSelesai extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_riwayat_belum, container, false);
        //super.onCreate(savedInstanceState);
        progressDialog = new ProgressDialog(getContext());
        recyclerView = (RecyclerView) rootView.findViewById(R.id.rbRecyclerView); //referensi variable
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) { //foreach memanggil data
                    ...
                    if(imageUploadInfo.getUser().equals(firebaseUser.getEmail().toString()) && imageUploadInfo.getStatus().equals("Belum Lunas")){
